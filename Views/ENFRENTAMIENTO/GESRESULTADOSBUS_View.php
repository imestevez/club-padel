	 ...
	 <div class="row">
			<div class="col-12">
			    	<section class="box">
			    		...
			    		<form id="form1" name="form1" method="post" action="../Controllers/ENFRENTAMIENTO_Controller.php?action=SHOW_ETAPAS&campeonato_ID=<?php echo $this->campeonato_ID?>">
					...
					?>
							<tr>
										...
										<?php }else{ ?>
											<td><?php echo "-"?></td>
											<td>
											<a class="button small" href="../Controllers/ENFRENTAMIENTO_Controller.php?action=INTRODUCIRRESULTADO&enfrentamiento_ID=<?=$row['ENFRENTAMIENTO_ID']?>&etapa=<?=$this->actual?>&grupo_id=<?=$this->grupo_id?>">Resultado</a>
											</td>
										<?php } ?>
